...
from robosuite.environments.darias import DariasEnv
...
class DariasClothGrasp(DariasEnv):
    def __init__(
            self,
    ...
    def _load_model(self):
        ...
        # )
        cloth = ClothObject()
        self.mujoco_objects = OrderedDict([("cloth", cloth)])
        self.n_objects = len(self.mujoco_objects)

        # task includes arena, robot, and objects of interest
        self.model = ClothGrasp(
            self.mujoco_arena,
            self.mujoco_robot,
            self.mujoco_objects,
